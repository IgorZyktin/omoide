...
down_revision: str | None = '55564454e156'
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f('ix_signatures_crc32_item_id'), 'signatures_crc32', ['item_id'], unique=True
    )
    op.create_index(
        op.f('ix_signatures_crc32_signature'), 'signatures_crc32', ['signature'], unique=False
    )
    ...
    op.create_index(op.f('ix_signatures_md5_item_id'), 'signatures_md5', ['item_id'], unique=True)
    op.create_index(
        op.f('ix_signatures_md5_signature'), 'signatures_md5', ['signature'], unique=False
    )
