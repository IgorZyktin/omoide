...
down_revision: str | None = 'd8231390e04b'
...
def downgrade() -> None:
    """Removing stuff."""
    op.execute("""REVOKE USAGE, SELECT ON SEQUENCE item_notes_id_seq FROM omoide_app;""")
    op.execute("""REVOKE USAGE, SELECT ON SEQUENCE items_id_seq FROM omoide_app;""")
    op.execute("""REVOKE USAGE, SELECT ON SEQUENCE media_id_seq FROM omoide_app;""")
    op.execute("""REVOKE USAGE, SELECT ON SEQUENCE registered_workers_id_seq FROM omoide_app;""")
    op.execute("""REVOKE USAGE, SELECT ON SEQUENCE serial_lock_id_seq FROM omoide_app;""")
    op.execute("""REVOKE USAGE, SELECT ON SEQUENCE serial_operations_id_seq FROM omoide_app;""")
    op.execute("""REVOKE USAGE, SELECT ON SEQUENCE users_id_seq FROM omoide_app;""")

    op.execute("""REVOKE USAGE, SELECT ON SEQUENCE item_notes_id_seq FROM omoide_worker;""")
    op.execute("""REVOKE USAGE, SELECT ON SEQUENCE items_id_seq FROM omoide_worker;""")
    op.execute("""REVOKE USAGE, SELECT ON SEQUENCE media_id_seq FROM omoide_worker;""")
    op.execute("""REVOKE USAGE, SELECT ON SEQUENCE registered_workers_id_seq FROM omoide_worker;""")
    op.execute("""REVOKE USAGE, SELECT ON SEQUENCE serial_lock_id_seq FROM omoide_worker;""")
    op.execute("""REVOKE USAGE, SELECT ON SEQUENCE serial_operations_id_seq FROM omoide_worker;""")
    op.execute("""REVOKE USAGE, SELECT ON SEQUENCE users_id_seq FROM omoide_worker;""")

    op.execute("""REVOKE SELECT ON SEQUENCE item_notes_id_seq FROM omoide_monitoring;""")
    op.execute("""REVOKE SELECT ON SEQUENCE items_id_seq FROM omoide_monitoring;""")
    op.execute("""REVOKE SELECT ON SEQUENCE media_id_seq FROM omoide_monitoring;""")
    op.execute("""REVOKE SELECT ON SEQUENCE registered_workers_id_seq FROM omoide_monitoring;""")
    op.execute("""REVOKE SELECT ON SEQUENCE serial_lock_id_seq FROM omoide_monitoring;""")
    op.execute("""REVOKE SELECT ON SEQUENCE serial_operations_id_seq FROM omoide_monitoring;""")
    op.execute("""REVOKE SELECT ON SEQUENCE users_id_seq FROM omoide_monitoring;""")
