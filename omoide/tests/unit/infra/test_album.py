...
def test_album_long_middle():
    ...
    assert _str(album) == 'a ... l m [n] o p ... z'
...
def test_album_transitions():
    ...
    assert _ch(album) == 'a b c [d] e f g h ... z'
    assert _ch(album) == 'a b c d [e] f g h ... z'
    assert _ch(album) == 'a ... d e [f] g h ... z'
    assert _ch(album) == 'a ... e f [g] h i ... z'
    assert _ch(album) == 'a ... f g [h] i j ... z'
    assert _ch(album) == 'a ... g h [i] j k ... z'
    assert _ch(album) == 'a ... h i [j] k l ... z'
    assert _ch(album) == 'a ... i j [k] l m ... z'
    assert _ch(album) == 'a ... j k [l] m n ... z'
    assert _ch(album) == 'a ... k l [m] n o ... z'
    assert _ch(album) == 'a ... l m [n] o p ... z'
    assert _ch(album) == 'a ... m n [o] p q ... z'
    assert _ch(album) == 'a ... n o [p] q r ... z'
    assert _ch(album) == 'a ... o p [q] r s ... z'
    assert _ch(album) == 'a ... p q [r] s t ... z'
    assert _ch(album) == 'a ... q r [s] t u ... z'
    assert _ch(album) == 'a ... r s [t] u v ... z'
    assert _ch(album) == 'a ... s t [u] v w ... z'
