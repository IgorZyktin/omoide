...
@dataclass
class NewFile:
    """Metadata for a file uploaded by the user.

    The actual payload is streamed straight from the HTTP request into
    ``AbsContentStorage`` and never lives on this object.
    """
